...
@section('content')
    ...
    <div class="justify-content-end d-flex">
        <a href="{{ route(datasurat.create') }}" class="btn btn-primary" style="margin-top: 1em">Tambah</a>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            ...
            @foreach ($letters as $item)
                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ ucwords($item['letterype_id']) }}</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('datasurat.destroy', $item['id']) }}" method="POST">
                            @csrf
                            @method('DELETE')
